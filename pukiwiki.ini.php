...
$modifierlink = 'http://www.motanilab.info/';

// Default page name
$defaultpage  = 'oh wiki';     // Top / Default page
...
// Default: always fail
$adminpass = '{x-php-md5}' . md5('meri0506');
...
//$pagereading_kanji2kana_encoding = 'UFT-8'; // Default for Windows
